            ...
            <Slider {...settings} className="my-14">
                {
                  allDocs.map((doc: any, index) => {
                    return <ArticleCard key={index} src={doc.image} title={doc.title} slug={doc.slug} description={doc.description}></ArticleCard>
                  })
                }
              ...
              <ArticleCard src="https://images.unsplash.com/photo-1522252234503-e356532cafd5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZGV2ZWxvcGVyfGVufDB8fDB8fHww" title="UX/UI Best practices" description="Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequatur laboriosam nemo." slug="hola"/>
